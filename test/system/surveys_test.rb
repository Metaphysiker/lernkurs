...
class SurveysTest < ApplicationSystemTestCase
  ...
  test "creating a Survey" do
    ...
    fill_in "Counter1", with: @survey.counter1
    fill_in "Counter2", with: @survey.counter2
    fill_in "Question1", with: @survey.question1
    fill_in "Question2", with: @survey.question2
